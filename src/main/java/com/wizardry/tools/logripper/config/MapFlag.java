...
public class MapFlag extends Flag {
    ...
    public static final String ALIAS = "map";
    public static final String LONG_OPTION = "map";
    public static final Character SHORT_OPTION = 'm';
     ...
     */
    public MapFlag(boolean hasShortOption ) {
        super( hasShortOption ? SHORT_OPTION : null, LONG_OPTION, ALIAS, "Maps the provided path." );
    }
     ...
     */
    public MapFlag(String aDescription ) {
     ...
     *        only the long option takes effect.
     */
    public MapFlag(String aDescription, boolean hasShortOption ) {
